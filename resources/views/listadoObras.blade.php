        ...
        <div class="container">
            ...
            <form class="mt-45" id="obra-form" method="post" accept-charset="utf-8" enctype="multipart/form-data">
                ...
                <div class="main-primary col-sm-8 col-md-8 col-xs-12 br-5 p15 mb-30 col-sm-offset-2">
                    <h3 class="header3">Bienvenido al listado de Obras</h3>                    
                      
                    <a href="{{route('crearobra')}}" class="btn btn-warning btn-block" style="float: left; width: calc(50% - 10px); margin-top: 0px; margin-right: 10px">+ Crear obra</a>
                    <a href="{{route('descargarobras')}}" class="btn btn-primary btn-block" style="float: left; width: 50%; margin-top: 0px">↓ Descargar CSV de obras</a>
                        ...
                        <table class="table table-responsive" style="margin-bottom: 0px; margin-top: 20px; width: 100%; float: left ">
                            ...
                            @foreach($obras as $obra)
                                <tr>
                                    ...
                                    <td>{!!$obra->nombre!!}</td>
                                    <td>{!!$obra->barrio!!}</td>
                                    <td><a href="{{route('crearobra').'/'.$obra->id}}" class="btn btn-warning btn-block" style="float: left; width: 100%">Editar</a></td>
                                </tr>
                            @endforeach
                            </tbody>
                        </table>
                    @else
                    <span style="margin-top: 40px; margin-bottom: 40px; width: 100%; float: left"><center>- Sin obras creadas -</center></span>    
                    @endif
