        ...
        <div class="container">
            ...
            <form class="mt-45" id="form" method="post" accept-charset="utf-8" enctype="multipart/form-data">
                ...
                <div class="main-primary col-sm-8 col-md-8 col-xs-12 br-5 p15 mb-30 col-sm-offset-2">
                    <h3 class="header3">Bienvenido a la @if($tipo=="show") edición @else captura @endif de evento @if($tipo=="show") {{$evento->id_evento}} @endif</h3>                    
                    ...
                    <div class="float-left"> 
                        <label>Categoría <mark></mark></label>
                        <select class="form-control mb-30 select2-single" required name="categoria">
                            ...
                            <option value="Museos y galerías">Museos y galerías</option>         
                        </select>
                    </div> 
                    
                    <div class="inputfield">                        
                        <input type="text" class="texto capitalize"  minlength="2" required name="nombre" />
                        <label>Nombre <mark></mark></label>
                    </div> 
                    <div class="inputfield">                        
                        <input type="text" class="texto"  minlength="2"  name="enlace" required />
                        <label>Enlace<mark></mark></label>
                    </div> 
...
@section('page-js-script')
  ...
  <script>
    ...
    $(document).ready(function(){
      ...
      @if($tipo=="show")
        $("[name='nombre']").val('{!!$evento->nombre!!}');
        $("[name='enlace']").val('{!!$evento->enlace!!}');
        $("[name='categoria']").val('{!!$evento->categoria!!}');
      @endif
      ...
      $("#form").on('submit', function(){
        ...
        $.ajax({
            ...
            error: function(xhr, resp, text) {
                ...
                $(".loading-main").fadeOut();
                $(".responsemessage").addClass("errorresponse");
                $(".responsemessage").addClass("showed").html("Ocurrió un error guardando el evento: "+error+". Línea: "+linea).slideDown();
            }
        });
        return false;
      });
