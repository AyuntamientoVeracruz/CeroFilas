...
@section('content')
    ...
    <div class="wrappercontainer">
        ...
        <div class="container">
            ...
            <form class="mt-45" id="obra-form" method="post" accept-charset="utf-8" >
                
                <div class="main-primary col-sm-8 col-md-8 col-xs-12 br-5 p15 mb-30 col-sm-offset-2">
                    <h3 class="header3">Bienvenido al listado de Entretenimiento</h3>                    
                        ...
                        <table class="table table-responsive" style="margin-bottom: 0px; margin-top: 20px; width: 100%; float: left ">
                            ...
                            @foreach($eventos as $evento)
                                <tr>
                                    ...
                                    <td>{!!$evento->nombre!!}</td>
                                    <td><a href="{{$evento->enlace}}" class="btn btn-warning btn-block" style="float: left; width: 100%" target="_blank">Ver</a></td>
                                </tr>
                            @endforeach
                            </tbody>
                        </table>
                    @else
                    <span style="margin-top: 40px; margin-bottom: 40px; width: 100%; float: left"><center>- Sin entretenimientos creados -</center></span>    
                    @endif
