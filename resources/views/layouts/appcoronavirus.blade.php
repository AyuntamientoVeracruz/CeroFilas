...
<head>
    ...
    <title>Ayuntamiento de Veracruz</title>
    <!--bootstrap main-->
    ...
    <style type="text/css">
        ...
        .headerwrapper{ background-image:url(../images/coronavirus.jpg)}
        .headerwrapper:before{background:rgba(0,0,0,0.6)}
    </style>
</head>
...
<body id="home"> 
        ...
        <div class="container">
            <header>                    
                ...
                <div class="menucontainer">
                    <ul class="menu">
                        <li><a href="{{route('infografiacoronavirus')}}">Infografías</a></li>
                        <li><a href="{{route('listadoeventoscoronavirus')}}">Entretenimiento</a></li>
    ...
    <script type="text/javascript" src="https://informacionfinanciera.veracruzmunicipio.gob.mx/carnaval/vendors/js/iframeResizer.contentWindow.min.js"></script>
