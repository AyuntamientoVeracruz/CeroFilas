...
! function(t, e) {
    ...
    C.summernote = C.summernote || {
        ...
        "en-US": {
            ...
            link: {
                link: "Link",
                insert: "Insertar/editar link",
                unlink: "Unlink",
                edit: "Edit",
                textToDisplay: "Texto a desplegar",
                url: "A que URL debe ir el link?",
                openInNewWindow: "Abrir link en ventana nueva"
            },
            table: {
                table: "Table",
        ...
        oe = function() {
            ...
            return t.prototype.initialize = function() {
                var t = this.options.dialogsInBody ? this.$body : this.$editor,
                    ...
                    o = '<input type="button" href="#" class="btn btn-warning note-btn note-btn-warning note-link-btn" value="Guardar" disabled>';
