...
<html >
   <head>
    ...
    <body>
		...
		<div class="container">
        <form id="entry" method="POST" action="<?php echo e(route('login', app()->getLocale())); ?>" autocomplete="off">
		<?php echo csrf_field(); ?>
            ...
            <div class="submit">
                <button type="submit"><?php echo e(__('btnEner')); ?></button>
            </div>
                       
            <a href="<?PHP echo url(app()->getLocale()."/forgot") ?>" class="forgot"><?php echo e(__('btnForgotten')); ?></a>
        </form>
        </div>
		</div>
