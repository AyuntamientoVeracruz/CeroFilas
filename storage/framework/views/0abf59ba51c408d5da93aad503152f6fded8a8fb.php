...
<!--<link rel="stylesheet" href="<?php echo e(url('/sis/vendors/css/bootstrap-datetimepicker.css')); ?>" type="text/css" media="all">-->
<style type="text/css">
...
<?php $__env->startSection('content'); ?>
  ...
  <main class="main">
    ...
    <ol class="breadcrumb">
      ...
      <li class="breadcrumb-item"><a href="route('usuarios', app()->getLocale())"><?php echo e(__('lblUsers')); ?></a></li>
      <li class="breadcrumb-item active">><?php echo e(__('lblAbsences')); ?></li>
    </ol>
              ...
              <form method="get" class="form-horizontal tabsearch">
                  <div class="form-group row">
                      <div class="col-lg-3">
                          ...
                          data-action = "store"
                          data-usuario= "<?php echo e($usuario->id_user); ?>"
                          data-title  = "Nueva ausencia"><?php echo e(__('lblCreateNewAbsence')); ?> <i class="icon-arrow-right"></i></a>
                      </div>
                      <div class="col-lg-9 col-md-12 ">
                        <div class="col-md-6 separator leftfilter">
                            <div class="input-prepend input-group">
                              <div class="input-group-prepend">
                                <span class="input-group-text"><i class="fa fa-calendar" style="margin-right:10px"></i> <?php echo e(__('lblFromStartDate')); ?></span>
                              </div>
                              <input id="datetimepicker1" class="form-control" size="16" type="text" placeholder="YYYY-MM-DD" required value="<?php echo e($filtersfecha1); ?>"
                           ...
                           <div class="col-md-6 separator rightfilter">
                            <div class="input-prepend input-group">
                              <div class="input-group-prepend">
                                <span class="input-group-text"><?php echo e(__('lblEndtDate')); ?></span>
                              </div>
                              <input id="datetimepicker2" class="form-control" size="16" type="text" placeholder="YYYY-MM-DD" required value="<?php echo e($filtersfecha2); ?>"
          ...
          <div class="cardsoutside">
              ...
              <div class="card">
                  ...
                  <div class="card-header">
                    <h5 style="margin-bottom:0px">Ausencias de <?php echo e($usuario->nombre); ?></h5>
                  </div>
                                        ...
                                        <td style="padding-right:0px">
                                          <div style="float:left; width:165px">
                                            <a href="#" class="btn btn-warning btn-sm float-left open-modal" 
                                              ...
                                              data-target       = "#myModal"
                                              data-action       = "update"
                                              data-id           = "<?php echo e($ausencia->id_ausencia); ?>"
                                              data-title        = "Editando ausencia"
                                              data-fechainicio  = "<?php echo e($ausencia->fecha_inicioparsed); ?>"  
                                              data-fechafin     = "<?php echo e($ausencia->fecha_finparsed); ?>" 
                                              data-usuario      = "<?php echo e($ausencia->user_id); ?>"
                                              data-motivo       = "<?php echo e($ausencia->motivo); ?>" 
                                            >Editar</a> 

                                            <form id="fr_ausencia<?php echo e($ausencia->id_ausencia); ?>" action="<?php echo e(route('ausencias/destroy', app()->getLocale())); ?>" name="_method" method="post" style="float:left">
                                              <a href="#" 
                                              ...
                                              >Eliminar</a>
                                              <?php echo csrf_field(); ?>
                                              <input type="hidden" name="id_ausencia" value="<?php echo e($ausencia->id_ausencia); ?>"/>
                                            </form>

                                          </div>
                                        </td>
                                                                                       
                                        <td ><div style="float:left; width:150px; text-transform: capitalize;"><?php echo e($ausencia->fecha_iniciohuman); ?></div></td> 
                                        <td ><div style="float:left; width:150px; text-transform: capitalize;"><?php echo e($ausencia->fecha_finhuman); ?></div></td>
                                        <td ><div style="float:left; width:250px; text-transform: capitalize;"><?php echo e($ausencia->motivo); ?></div></td>
...
<?php $__env->startSection('page-js-script'); ?>
  <!--<script src="<?php echo e(url('/sis/vendors/js/bootstrap-datetimepicker.js')); ?>" type="text/javascript"></script> --> 
  <script>
    $(document).ready(function(){
      ...
      $("a.open-modal").click(function (e) {
        ...
        if ($(this).data('action') == "store"){
          ...
          modal.find('form').attr('action','<?php echo e(route("ausencias/store", app()->getLocale())); ?>');
        }
          ...
          modal.find('form').attr('action','<?php echo e(route("ausencias/update", app()->getLocale())); ?>');
        }
      });
