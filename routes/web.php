...
Route::group(['middleware' => 'cors'], function()
{
    ...
    Route::get('/multas/articulos-multa/{cvearticulo?}', [
      'as' => 'articulosmulta',
      'uses' => 'TransitoController@getArticulosMulta'
    ]);

});
/*
Route::group(['middleware' => 'SimpleApi'], function()
{
    //obtener monto de multa
    Route::post('/multas/obtenermulta/', [
      'as' => 'montomulta',
...
//crear obra
Route::get('/crearobra/{folio?}', [
  'as' => 'crearobra',
  'uses' => 'ObrasController@crearobra'
]);
...
Route::group(['middleware' => 'cors'], function()
{
   ...
   //descargar csv obras
    Route::get('/dataobras.json', [
      'as' => 'descargarobrasjson',
      'uses' => 'ObrasController@descargarobrasjson'
    ]);

    //descargar csv obras
    Route::get('/dataobras.csv', [
      'as' => 'descargarobras',
      'uses' => 'ObrasController@descargarcsvobras'
    ]);

});

//listado obras
Route::get('/listadoobras', [
  'as' => 'listadoobras',
  'uses' => 'ObrasController@listadoobras'
]);
...
//////////////////////////////////////////////////////////////////////
//crear acciones
Route::get('/crearaccion/{folio?}', [
  'as' => 'crearaccion',
  'uses' => 'ObrasController@crearaccion'
]);

//listado acciones
Route::get('/listadoacciones', [
  'as' => 'listadoacciones',
  'uses' => 'ObrasController@listadoacciones'
]);

//descargar csv acciones
Route::get('/dataacciones.csv', [
  'as' => 'descargarcsvacciones',
  'uses' => 'ObrasController@descargarcsvacciones'
]);

//guardar accion
Route::post('saveaccion', [
  'as' => 'accionsave',
  'uses' => 'ObrasController@accionsave'
]);
...
//home coronavirus
Route::get('/coronavirus', [
  'as' => 'homecoronavirus',
  'uses' => 'CoronavirusController@home'
]);

//infografia coronavirus
Route::get('/coronavirus/infografia', [
  'as' => 'infografiacoronavirus',
  'uses' => 'CoronavirusController@infografia'
]);

//crear evento
Route::get('/coronavirus/crearevento/{folio?}', [
  'as' => 'crearevento',
  'uses' => 'CoronavirusController@crearevento'
]);


//listado eventos
Route::get('/coronavirus/listadoeventos', [
  'as' => 'listadoeventoscoronavirus',
  'uses' => 'CoronavirusController@listadoeventos'
]);


//guardar evento
Route::post('/coronavirus/saveevento', [
  'as' => 'eventosave',
  'uses' => 'CoronavirusController@eventosave'
]);


//crear pregunta
Route::get('/coronavirus/crearpregunta/{folio?}', [
  'as' => 'crearpregunta',
  'uses' => 'CoronavirusController@crearpregunta'
]);


//guardar pregunta
Route::post('/coronavirus/savepregunta', [
  'as' => 'preguntasave',
  'uses' => 'CoronavirusController@preguntasave'
]);
